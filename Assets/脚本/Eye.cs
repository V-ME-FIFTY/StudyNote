...
namespace Assets
{
    public class Eye : MonoBehaviour, IDamageable, ITargetable
    {
        ...
        private void ApplyKnockback()
        {
               ...
               Vector2 knockbackDirection = (target != null)    ? (transform.position - target.transform.position).normalized : Vector2.up;
